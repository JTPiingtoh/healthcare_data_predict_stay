# PRKnn without nested knn model
import numpy as np
...
class PRKNeighborsClassifier2(KNeighborsMixin, ClassifierMixin, NeighborsBase):
    '''
    ...
    def _get_proximal_ratios(self):
        ...
        for id, x in enumerate(X):
            ...
            distances, knn_indices = self.kneighbors(x.reshape(1, -1), n_neighbors=self.n_neighbors)
    ...
    def predict(self, X, y=None):
        ...
        distances, indexes = self.kneighbors(X, n_neighbors=self.n_neighbors, weights=weights)
